...
// Check for status message from redirects
...
// Fetch customer orders with order_status
...
<body>
  <div class="container">
    ...
    <!-- Customer Orders Section with Status Management -->
    <div class="section">
      <div class="section-header">
        ...
        <table>
          ...
          <tbody>
            <?php while ($order = $orders_result->fetch_assoc()): 
              ...
              $status_lower = strtolower(str_replace(' ', '', $current_status));
            ...
            ?>
              <tr>
                ...
                <td>
                  <form method="POST" action="update_order_status.php" class="order-form">
                    <input type="hidden" name="order_id" value="<?= $order['order_id'] ?>">
                    <select name="order_status">
                      <option value="Pending" <?= $current_status === 'Pending' ? 'selected' : '' ?>>⏳ Pending</option>
                      <option value="Preparing" <?= $current_status === 'Preparing' ? 'selected' : '' ?>>👨‍🍳 Preparing</option>
