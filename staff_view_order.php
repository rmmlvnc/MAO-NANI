...
// Fetch order details with customer info and payment receipt
$order_stmt = $conn->prepare("
  SELECT o.*, c.first_name, c.last_name, c.phone_number, c.email,
         p.payment_method, p.payment_status, p.payment_date, p.payment_time
  FROM `orders` o
    ...
    <div class="content-box">
      <div class="order-info">
        ...
        <div class="order-meta">
          <span><?= date('F d, Y', strtotime($order['order_date'])) ?> at <?= date('h:i A', strtotime($order['order_time'])) ?></span>
          
          <?php if (!empty($order['receipt_number'])): ?>
            <span class="receipt-badge">Receipt: <?= htmlspecialchars($order['receipt_number']) ?></span>
          <?php endif; ?>

          <?php if (!empty($order['payment_method'])): ?>
            <span class="payment-badge"><?= htmlspecialchars($order['payment_method']) ?></span>
          <?php endif; ?>
